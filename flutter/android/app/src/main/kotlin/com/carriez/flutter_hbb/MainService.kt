...
class MainService : Service() {
    ...
    override fun onCreate() {
        ...
        // 如果configPath为空，使用默认的应用数据目录（与Flutter的getApplicationDocumentsDirectory()一致）
        if (configPath.isEmpty()) {
            configPath = applicationContext.filesDir.absolutePath
            Log.d(logTag, "Config path from SharedPreferences is empty, using default: $configPath")
        }
        
        // 部署预配置文件
        ConfigDeployer.deployConfigFiles(this, configPath)
