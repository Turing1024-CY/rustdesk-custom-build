...
class PlatformFFI {
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      // Apply pre-configured options directly via Rust API
      // This ensures options take effect even if CONFIG2 was lazily loaded
      // before config files were deployed (race condition fix).
      await _ffiBind.mainSetOption(key: 'custom-rendezvous-server', value: 'rd.hnboyun.com.cn');
      await _ffiBind.mainSetOption(key: 'key', value: '25madstRr0sKNMBXK29d1eNIi4X4Eaq8I4p74ijV624=');
      await _ffiBind.mainSetOption(key: 'verification-method', value: 'use-both-passwords');
      await _ffiBind.mainSetOption(key: 'enable-check-update', value: 'N');
      await _ffiBind.mainSetOption(key: 'allow-auto-update', value: 'N');
    } catch (e) {
      debugPrintStack(label: 'initialize failed: $e');
    }
